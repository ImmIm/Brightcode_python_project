...
class DumbAiTest(unittest.TestCase):
    def setUp(self):
        self.controller = ReverciController(8, '2','c', True, ('X', 'O'), 'c', 'd', 2)
        self.controller.game.rules.set_up_start()
   
    def test_make_move(self):
        res = self.controller.game.other_player.make_move(self.controller.game.rules, self.controller.game.board, 1, 2, self.controller.show_moves_tips(self.controller.game))
